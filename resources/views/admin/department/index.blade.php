            ...
            <div class="col-md-12">
                ...
                <div class="card card-cyan">
                    <div class="card-header">
                        <h3 class="card-title">
                            {{ session('locale') == 'ar' 
                            ? \App\Helpers\TranslateHelper::toArabic('Department List') 
                            : 'Department List' }}
                        </h3>
                        <a href="{{ route('admin.department.create') }}" class="btn btn-success float-right"><i class="fa fa-plus"></i>
                        {{ session('locale') == 'ar' 
                            ? \App\Helpers\TranslateHelper::toArabic('Add Department') 
                            : 'Add Department' }}
                    </a>
                    </div>
